...
export function SidebarNavItem({ navItem, isCollapsed }) {
  ...
  `;
    ...
    group
 `;
    const navItemContainerCollapsed = `${isCollapsed || tw `hover:(bg-skin-base text-skin-base-dark) justify-start`}`;
  ...
  `;
    ...
    return (_jsx("div", Object.assign({ className: `${isCollapsed || 'px-3'}` }, { children: _jsxs("div", Object.assign({ className: `${navItemContainer} ${navItemContainerCollapsed}` }, { children: [_jsx("div", Object.assign({ className: `max-w-[3.5rem] ${isCollapsed || 'px-3 p-1'}` }, { children: _jsxs("div", Object.assign({ className: tw `${navItemIconContainer}` }, { children: [_jsx(navItem.icon, { className: navItemIcon }), _jsx("div", Object.assign({ className: `${tooltip}` }, { children: navItem.label }))] })) })), _jsx(motion.div, Object.assign({ className: "text-md", animate: { scale: isCollapsed ? 0 : 1 }, transition: {
                        type: 'spring',
                        stiffness: 500,
                        damping: 40,
                    } }, { children: _jsx("div", Object.assign({ className: tw `text-md ${isCollapsed && 'hidden'}` }, { children: navItem.label })) }))] })) })));
}
